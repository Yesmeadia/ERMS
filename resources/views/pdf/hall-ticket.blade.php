@php
    ...
    if (str_starts_with($categoryName, 'RAINBOW') || str_starts_with($categoryName, 'PLANET')) {
        // RAINBOW 3/4/5 → green, PLANET → red
        $bannerColor = str_starts_with($categoryName, 'RAINBOW') ? '#2e7d32' : '#c62828';
