...
<head>
    ...
    <title>Invigilator Account Created</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <p>We are pleased to inform you that your staff / invigilator account has been successfully created. You can now access the portal to scan student hall tickets and mark examination attendance.</p>

            <div class="info-box">
                <p><strong>Assignment Details:</strong></p>
                @if($user->school)
                    <p>&bull; <strong>Assigned Center / School:</strong> {{ $user->school->name }} ({{ $user->school->code }})</p>
                @else
