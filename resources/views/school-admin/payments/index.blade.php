...
@section('content')
    ...
    @if($isRegistrationClosed ?? false)
        <div class="mb-6 p-4 bg-rose-950/40 border border-rose-900/50 text-rose-300 rounded-2xl text-xs font-semibold shadow-lg flex items-center gap-3">
            ...
            <div>
                <p class="font-extrabold text-sm text-rose-300">Registration Closed</p>
                <p class="text-rose-300/80 text-[11px] mt-0.5">Registration has been closed by the Board Super Admin. Fee payments for drafted candidates are currently blocked.</p>
            </div>
        </div>
    @endif
