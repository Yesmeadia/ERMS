...
@section('content')
    ...
    @if($student->status === 'Rejected' && $student->remarks)
        <div
            class="mb-6 p-4 rounded-2xl bg-rose-950/40 border border-rose-800/40 text-rose-200 shadow-[0_0_15px_rgba(244,63,94,0.05)]">
            <div class="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                    class="w-5 h-5 text-rose-400 shrink-0 mt-0.5">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                </svg>
                <div>
                    <h4 class="text-sm font-semibold text-rose-300">Registration Rejected by Board Admin</h4>
                    <p class="text-xs text-rose-200/90 mt-1 leading-relaxed"><strong
                            class="font-semibold text-rose-200">Remarks:</strong> {{ $student->remarks }}</p>
                    <p class="text-[10px] text-rose-400 mt-2">Please correct the information below and re-submit the
                        application.</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-slate-900/60 border border-slate-800/60 rounded-2xl p-6 space-y-4">
                <div class="border-b border-slate-800/60 pb-3 flex items-center gap-2 text-indigo-400">
                    ...
                    <h3 class="text-sm font-bold uppercase tracking-wider text-slate-200">Academic & Examination Details
                    </h3>
                </div>
