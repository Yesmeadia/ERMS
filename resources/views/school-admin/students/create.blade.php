            ...
            <div class="bg-slate-900/60 border border-slate-800/60 rounded-2xl p-6 space-y-4">
                <div class="border-b border-slate-800/60 pb-3 flex items-center gap-2 text-indigo-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M6.75 12.75v3.75c0 1.243 2.35 2.25 5.25 2.25s5.25-1.007 5.25-2.25v-3.75" />
                    </svg>
                    ...
                    <div>
                        ...
                        <select name="class_id" required
                            ...
                            @foreach($classes as $class)
                                <option value="{{ $class->id }}" @selected(old('class_id') == $class->id)>{{ $class->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <select name="examination_id" required
                        ...
                        @foreach($examinations as $exam)
                            <option value="{{ $exam->id }}" @selected(old('examination_id') == $exam->id)>{{ $exam->name }}
                            </option>
                        @endforeach
                    </select>
