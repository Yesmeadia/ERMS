...
@section('page_description', 'Manage all registered schools in the system')
@section('content')
    {{-- Header --}}
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-slate-800/60">
                    <th class="text-left px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">School
                    </th>
                    <th
                    ...
                    <tr class="hover:bg-slate-800/20 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div
                                        class="w-10 h-10 rounded-xl bg-slate-800 border border-slate-700/60 text-slate-400 flex items-center justify-center font-bold text-xs uppercase shrink-0">
                                ...
                                <div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($school->is_centre)
                                            <span
                                                class="px-2 py-0.5 rounded text-[10px] font-bold tracking-wider uppercase bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                                                Exam Centre
                                            </span>
                                        @endif
                                    </div>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.schools.destroy', $school) }}"
                                    onsubmit="return confirm('Delete this school? This will remove all associated data.')">
                                    @csrf @method('DELETE')
                                    <button type="submit"
