...
@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}"
            ...
            @csrf
            <div>
                <label class="block text-sm font-medium text-slate-300 mb-2">Category Name <span
            ...
            <div>
                <label class="block text-sm font-medium text-slate-300 mb-2">Category Code <span
                        class="text-rose-400">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-slate-300 mb-2">Registration Fee (INR) <span
                        class="text-rose-400">*</span></label>
                <input type="number" name="registration_fee" value="{{ old('registration_fee', '0.00') }}" required step="0.01" min="0"
