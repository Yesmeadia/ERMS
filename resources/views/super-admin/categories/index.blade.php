...
@section('page_description', 'Manage student category classifications')
@section('content')
    {{-- Header --}}
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-slate-800/60">
                    <th class="text-left px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Category
                    </th>
                    <th
                        class="text-left px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider hidden md:table-cell">
                        Code</th>
                    <th class="text-center px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">
                        Registration Fee</th>
                    <th class="text-center px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Students
                    </th>
                ...
                @forelse($categories as $category)
                    <tr class="hover:bg-slate-800/20 transition-colors">
                        ...
                        <td class="px-6 py-4 text-slate-400 hidden md:table-cell">
                            <span
                                class="px-2.5 py-1 rounded-lg bg-slate-800/80 text-xs font-mono text-slate-300">{{ $category->code }}</span>
                        </td>
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @else
                                <span
                                    class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-rose-500/10 text-rose-400 border border-rose-500/20">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center text-slate-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581a1.125 1.125 0 001.591 0l7.199-7.199a1.125 1.125 0 000-1.591L12.459 3.659A2.25 2.25 0 0010.868 3H9.568z" />
                            </svg>
