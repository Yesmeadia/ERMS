...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-white">Edit — {{ $examination->name }}</h2>
    </div>
    <form method="POST" action="{{ route('admin.examinations.update', $examination) }}" class="bg-slate-900/60 border border-slate-800/60 rounded-2xl p-8 space-y-5">
        @csrf @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div class="md:col-span-2">
                ...
                <input type="text" name="name" value="{{ old('name', $examination->name) }}" required
            ...
            <div>
                ...
                <input type="text" name="academic_year" value="{{ old('academic_year', $examination->academic_year) }}" required
            ...
            <div>
                ...
                <input type="date" name="registration_start_date" value="{{ old('registration_start_date', $examination->registration_start_date) }}" required
            ...
            <div>
                ...
                <input type="date" name="registration_end_date" value="{{ old('registration_end_date', $examination->registration_end_date) }}" required
            ...
            <div class="md:col-span-2">
                ...
                <input type="date" name="hall_ticket_release_date" value="{{ old('hall_ticket_release_date', $examination->hall_ticket_release_date) }}" required
        ...
        <div class="flex gap-4 pt-2">
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3 rounded-xl transition-all text-sm cursor-pointer">Update Examination</button>
