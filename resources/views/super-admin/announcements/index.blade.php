    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 bg-slate-900/60 p-6 rounded-2xl border border-slate-800/60 backdrop-blur-xl">
            ...
            <form action="{{ route('admin.announcements.store') }}" method="POST" class="space-y-5">
                ...
                <button type="submit"
                    class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm rounded-xl shadow-md shadow-indigo-600/10 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer">
