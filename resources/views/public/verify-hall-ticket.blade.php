...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .status-pill.pending-st {
            background: rgba(251, 191, 36, 0.1);
            color: #fbbf24;
            border: 1px solid rgba(251, 191, 36, 0.25);
        }

        .status-pill.rejected-st {
            ...
            <div class="container">
                    ...
                    <div class="status-banner not-found fade-up">
                        ...
                        <div>
                            ...
                            <p class="status-desc color-muted">
                                No hall ticket or registration record matched <strong
                                    style="color:#e2e8f0;">{{ $number }}</strong>. Please double-check the number and try
                                again.
                            </p>
                        </div>
                    </div>
                ...
                @elseif($verified)
                    ...
                    <div class="status-banner verified fade-up">
                        ...
                        <div>
                            ...
                            <p class="status-desc color-muted">This hall ticket is officially issued and board-verified. The
                                candidate is cleared to appear for the examination.</p>
                        </div>
                    </div>
                    ...
                    @if($student->hall_ticket_number)
                        <div class="ticket-box fade-up-2">
                            ...
                            @if($student->hall_ticket_issued_at)
                                <div class="ticket-issued">Issued on {{ $student->hall_ticket_issued_at->format('d M Y, h:i A') }}
                                </div>
                            @endif
                        </div>
                    @endif
                    ...
                    <div class="candidate-card fade-up-2">
                        ...
                        {{-- Privacy notice --}}
                        <div
                            style="padding: 12px 28px; border-top: 1px solid var(--border); font-size: 11.5px; color: var(--muted); display: flex; align-items: center; gap: 7px;">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" style="width:13px;height:13px;flex-shrink:0;">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                            </svg>
                            Personal details (date of birth, parent names, registration number) are withheld from public
                            display to protect candidate privacy.
                        </div>
                    </div>
                ...
                @else
                    ...
                    <div class="status-banner pending fade-up">
                        ...
                        <div>
                            ...
                            <p class="status-desc color-muted">
                                A record for <strong style="color:#e2e8f0;">{{ $student->name }}</strong> was found, but the
                                hall ticket has not yet been issued. Current status: <strong
                                    style="color:#e2e8f0;">{{ $student->status }}</strong>.
                            </p>
                        </div>
                    </div>
                ...
                <div class="search-again fade-up-3">
                    ...
                    <form class="search-form" action="{{ url('/verify/hall-ticket') }}" method="GET"
                        ...
                        <input type="text" class="search-input" placeholder="Enter Hall Ticket or Reg. Number"
                            name="number">
